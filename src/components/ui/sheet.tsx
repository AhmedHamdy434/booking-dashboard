    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "data-[side=start]:inset-y-0 data-[side=start]:start-0 data-[side=start]:h-full data-[side=start]:w-3/4 data-[side=start]:border-e sm:data-[side=start]:max-w-sm",
          "data-[side=end]:inset-y-0 data-[side=end]:end-0 data-[side=end]:h-full data-[side=end]:w-3/4 data-[side=end]:border-s sm:data-[side=end]:max-w-sm",
          ...
          "data-[side=start]:data-open:slide-in-from-left-10 rtl:data-[side=start]:data-open:slide-in-from-right-10",
          "data-[side=start]:data-closed:slide-out-to-left-10 rtl:data-[side=start]:data-closed:slide-out-to-right-10",
          "data-[side=end]:data-open:slide-in-from-right-10 rtl:data-[side=end]:data-open:slide-in-from-left-10",
          "data-[side=end]:data-closed:slide-out-to-right-10 rtl:data-[side=end]:data-closed:slide-out-to-left-10",
          className
        )}
        {...props}
      >
